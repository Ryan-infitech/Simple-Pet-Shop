...
const Cart = () => {
  ...
  const { cartItems, cartSummary, isLoading, updateQuantity, removeFromCart } = useCart();
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/30 to-rose-50/30">
      <div className="container py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">            {/* Cart Items */}
              ...
              <Card className="border-0 bg-card/50 backdrop-blur sticky top-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="text-center text-xs text-muted-foreground">
                    Ongkos kirim akan dihitung berdasarkan lokasi pengiriman
                  </div>
                </CardContent>
              </Card>
            </div>
