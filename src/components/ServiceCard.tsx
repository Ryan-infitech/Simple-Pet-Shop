...
const ServiceCard = ({ name, description, price, duration, image, rating, available }: ServiceCardProps) => {
  return (
    <Card className="group overflow-hidden hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur">
      <div className="relative">
        ...
        <div className="absolute top-3 right-3">
          <Badge variant={available ? "default" : "secondary"} className={available ? "bg-green-500" : "bg-gray-400"}>
